...
export default function Register() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (result[0] === true) {
        setSuccess("Successfully registered. You'll receive a confirmation email!");
    ...
    <div className="min-h-screen flex items-center justify-center p-4" style={{
      ...
      <div className="w-full max-w-5xl">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl font-bold text-white mb-2">Join Dashboard</h1>
          <p className="text-indigo-100">Create your account and start exploring</p>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            ...
            <div className="bg-white rounded-3xl shadow-2xl p-8">
              <h2 className="text-2xl font-bold text-gray-800 mb-6">Account Info</h2>
          ...
          <div className="bg-white rounded-3xl shadow-2xl p-8">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full text-white font-semibold py-3 rounded-xl transition-all shadow-lg hover:shadow-xl disabled:opacity-50 mb-6"
              style={{ 
            ...
            <p className="text-center text-sm text-gray-600 mt-6">
              ...
              <a href="/login" className="font-semibold hover:underline" style={{ color: '#FF214F' }}>
                Sign in
              </a>
            </p>
          </div>
